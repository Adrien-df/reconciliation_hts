...
if __name__ == "__main__":
    ...
    predictions = np.load("Data_Examples/predictions_auto_arima_m5_1000_to_1100.npy",allow_pickle=True)
    reals = np.load("Data_Examples/real_value_m5_1000_to_1100.npy",allow_pickle=True)
    ...
    #for val in range(40) :
       # print(object.proba_reconcile(column_to_reconcile=val))
